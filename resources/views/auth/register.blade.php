...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 col-md-8 col-md-offset-2">
            <h1 class="main-title">Register (* required)</h1>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-md-8 col-md-offset-2">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group{{ $errors->has('job_type') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-4">
                        <label for="job_type" class="form-check-label">
                            Freelancer
                            <input id="is_freelancer" type="checkbox" class="form-check-input"  name="is_freelancer" value="1" @if(old('is_freelancer')) checked="checked" @endif />
                        </label>
                    </div><!--end of freelancer -->
                    <div class="col-md-4">
                        <label for="job_type" class="form-check-label">
                            Permanent
                            <input id="is_permanent" type="checkbox" class="form-check-input"  name="is_permanent" value="1" @if(old('is_permanent')) checked="checked" @endif />
                        </label>
